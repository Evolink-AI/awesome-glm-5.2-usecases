...
<a href="https://evolink.ai/glm-5.2?utm_source=github&utm_medium=readme&utm_campaign=awesome-glm-5.2-usecases"><img src="images/zh-tw.png" alt="GLM-5.2 高訊號使用案例倉庫 banner" width="760"></a>
...
透過 Evolink 的 OpenAI 相容 Chat Completions API 使用 GLM-5.2。先在 [Evolink](https://evolink.ai?utm_source=github&utm_medium=readme&utm_campaign=awesome-glm-5.2-usecases) 取得 API key，然後在執行請求前設定為 `EVOLINK_API_KEY`。
...
| 章節 | 案例 |
|---|---|
| [📏 Benchmark 與前沿評測](#benchmarks-frontier-evaluation) | Case 1-12 |
| [💻 Coding Agent 與長上下文工作流](#coding-agents-long-context-workflows) | Case 13-22 |
| [🎮 上手 Demo 與 Showcase](#hands-on-demos-showcase-builds) | Case 23-30 |
| [🔌 供應商與工具整合](#provider-tool-integrations) | Case 31-42 |

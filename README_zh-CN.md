...
<a href="https://evolink.ai/glm-5.2?utm_source=github&utm_medium=readme&utm_campaign=awesome-glm-5.2-usecases"><img src="images/zh.png" alt="GLM-5.2 高信号使用案例仓库 banner" width="760"></a>
...
| 章节 | 案例 |
|---|---|
| [📏 Benchmark 与前沿评测](#benchmarks-frontier-evaluation) | Case 1-12 |
| [💻 Coding Agent 与长上下文工作流](#coding-agents-long-context-workflows) | Case 13-22 |
| [🎮 上手 Demo 与 Showcase](#hands-on-demos-showcase-builds) | Case 23-30 |
| [🔌 供应商与工具集成](#provider-tool-integrations) | Case 31-42 |
| [💸 成本、定价与本地部署](#cost-pricing-local-deployment) | Case 43-51 |
| [🧭 限制、Caveat 与安全信号](#limits-caveats-safety-signals) | Case 52-59 |

...
| 案例 | 展示重点 | 类型 |
|---|---|---|
| [Case 180: Hermes SSD Recovery Skill Loop](#case-180) | 如果你想在面向修复的 agent loop 里测试 GLM-5.2，可以看这个案例，因为 ShankhadeepSho1 说 Hermes 加 GLM 5.2 诊断了一块故障 NAS SSD，修好了问题，然后把修复方案封装成了可复用 skill。 | 演示 |

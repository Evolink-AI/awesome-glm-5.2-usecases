...
| 案例 | 展示重点 | 类型 |
|---|---|---|
| [Case 194: CuTeDSL Kernel Skill Open Source](#case-194) | 如果你想研究 GLM-5.2 在可复用 kernel 调试 skill 里的表现，可以看这个案例，因为作者把一个 CuTeDSL 的 Hermes skill 开源出来，并明确说 GLM-5.2 在调试和编写 kernels 时特别省成本。 | 教程 |

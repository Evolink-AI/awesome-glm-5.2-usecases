...
<a href="https://evolink.ai/glm-5.2?utm_source=github&utm_medium=readme&utm_campaign=awesome-glm-5.2-usecases"><img src="images/fr.png" alt="Dépôt de cas d’usage GLM-5.2 banner" width="760"></a>
...
Essayer sur Evolink: [GLM-5.2](https://evolink.ai/glm-5.2?utm_source=github&utm_medium=readme&utm_campaign=awesome-glm-5.2-usecases)
...
Utilisez GLM-5.2 via l’API Chat Completions compatible OpenAI d’Evolink. Obtenez une API key sur [Evolink](https://evolink.ai?utm_source=github&utm_medium=readme&utm_campaign=awesome-glm-5.2-usecases), puis définissez-la comme `EVOLINK_API_KEY` avant d’exécuter la requête.

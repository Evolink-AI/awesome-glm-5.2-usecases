...
Vollständige GLM-5.2 API-Referenz: [GLM-5.2 API docs öffnen](https://docs.evolink.ai/en/api-manual/language-series/glm-5.2/glm-5.2-api?utm_source=github&utm_medium=readme&utm_campaign=awesome-glm-5.2-usecases).
...
| Fall | Fokus | Typ |
|---|---|---|
| [Case 207: Stable Fluids Browser Benchmark](#case-207) | Nutze diesen Fall, um GLM-5.2 bei algorithmisch anspruchsvollen Browser-Physics-Builds zu vergleichen, denn AlicanKiraz0 führte einen Stable-Fluids-HTML-Benchmark aus und gab GLM 5.2 Max 88 von 100 Punkten. | Evaluation |
| [Case 199: Epoch Open-Weight Index Lead](#case-199) | Nutze diesen Fall, um GLM-5.2 auf einer langfristigen Fähigkeitskurve einzuordnen, denn Epoch AI schätzt 152 Punkte auf seinem Capabilities Index und bezeichnet es als das stärkste Open-Weight-Modell im eigenen Evaluationssatz. | Benchmark |
| [Case 196: Databricks Internal Harness Eval](#case-196) | Nutze diesen Fall, um GLM-5.2 auf einer großen privaten Engineering-Codebasis zu benchmarken, denn Databricks sagt, dass die interne Auswertung über Arbeit von mehr als 3.000 Engineers zeigte, dass GLM 5.2 sehr stark performte und die Wahl des Harness allein die Kosten um etwa 2x senken kann. | Bewertung |
| [Case 190: NatureBench Open-Weight Runner-Up](#case-190) | Nutze diesen Fall, um GLM-5.2 bei Scientific-Agent-Arbeit zu benchmarken, denn NatureBench sagt, dass GLM-5.2 direkt auf Platz zwei insgesamt debütierte und das Open-Weight-Feld über 90 Aufgaben in sechs wissenschaftlichen Domänen anführte. | Benchmark |
| [Case 189: Terminal-Bench 45-Task Cost Tradeoff](#case-189) | Nutze diesen Fall, um GLM-5.2 gegen GPT-5.5 im selben Agent-Harness zu vergleichen, denn ein 45-Task-Terminal-Bench-Lauf setzte GLM-5.2 auf 25 Siege gegenüber 29 für GPT-5.5 bei rund 40% geringeren Kosten mit Prompt Caching. | Bewertung |
| [Case 188: Harvey LAB-AA Legal-Agent Tie](#case-188) | Nutze diesen Fall, um GLM-5.2 bei echter Legal-Agent-Arbeit zu benchmarken, denn Harvey LAB-AA setzt GLM-5.2 Max auf 7,5% All-Pass, gleichauf mit Claude Opus 4.8 über 120 private Aufgaben in 24 Rechtsgebieten. | Benchmark |
...
| Fall | Fokus | Typ |
|---|---|---|
| [Case 202: Command Code Space Shooter Feature Win](#case-202) | Nutze diesen Fall, um GLM-5.2 bei einem One-Shot-Build für interaktive UI zu vergleichen, denn Command Code ließ denselben Retro-Space-Shooter-Prompt über Fable 5, GPT 5.5, GLM 5.2 und DeepSeek V4 Pro laufen und setzte GLM bei den Features an die Spitze. | Bewertung |
...
| [Case 192: Command Code Flappy Bird UX Split](#case-192) | Nutze diesen Fall, um GLM-5.2 bei leichten Design-Game-Aufgaben zu vergleichen, denn der Autor jagte denselben Flappy-Bird-Prompt durch Command Code und kam zu dem Schluss, dass Fable 5 beim UX nicht sinnvoll besser war, obwohl es fast neunmal so viel kostete wie GLM-5.2. | Bewertung |
...
| Fall | Fokus | Typ |
|---|---|---|
| [Case 208: Open Molecular Viewer Agent Stack](#case-208) | Nutze diesen Fall, um GLM-5.2 in einen offenen Scientific-Inspection-Workflow einzubinden, denn MaziyarPanahi kombinierte GLM-5.2 über Hugging Face Inference Providers mit Qwen3-VL auf llama.cpp, Mol* und PydanticAI, um eine EGFR-plus-Erlotinib-Struktur aus einem einzigen Prompt zu rendern und zu kommentieren. | Integration |
| [Case 204: Perplexity Advisor WANDR Cost Baseline](#case-204) | Nutze diesen Fall, um die GLM-5.2-Ökonomie in einem gerouteten Computer-Use-Harness abzuschätzen, denn Perplexity sagt, dass sein GLM-5.2-plus-Advisor-Setup auf WANDR bei 2.1x gegenüber 6.1x für Opus liegt und im Schnitt rund halb so viel kostet. | Bewertung |
| [Case 203: Coworker Open Artifacts Routing](#case-203) | Nutze diesen Fall, um GLM-5.2 in Enterprise-Artifact-Workflows zu bringen, denn Coworker sagt, dass Open Artifacts Docs, Decks, PDFs, Spreadsheets, Dashboards und Apps erzeugen kann, während sein optimierter Router den Tokenverbrauch um etwa 5x senkt und trotzdem US-gehostetes GLM 5.2 anbietet. | Integration |
| [Case 201: DotCode Context Upload Workflow](#case-201) | Nutze diesen Fall, um GLM-5.2 in einer privaten Coding-Sandbox mehr Projektkontext zu geben, denn DotCode hat GLM 5.2 zusammen mit Uploads für Screenshots, Bilder, CSVs, PDFs, Source-Dateien und ZIPs ergänzt, die in denselben Filesystem-und-Terminal-Workflow fließen. | Integration |
| [Case 198: Dahl 100M Free GLM Endpoint](#case-198) | Nutze diesen Fall, um GLM-5.2 über einen OpenAI-kompatiblen Weg ohne Kreditkarte auszuprobieren, denn Dahl Inference bietet 100M freie Tokens für GLM 5.2 FP8 und zeigt, wie man einen Schlüssel erstellt und `/v1/chat/completions` aufruft. | Tutorial |
...
| [Case 193: 0G TeeML Private Inference Route](#case-193) | Nutze diesen Fall, um GLM-5.2 über einen Privacy-First-Provider-Pfad zu routen, denn 0G sagt, dass GLM 5.2 jetzt in TeeML läuft, mit Prompts in einer TEE-Enklave und Preisen unterhalb der offiziellen Route. | Integration |
...
| Fall | Fokus | Typ |
|---|---|---|
| [Case 209: Colibri 25GB RAM Sparse Streaming](#case-209) | Nutze diesen Fall, um die neue Untergrenze lokaler GLM-5.2-Experimente zu verstehen, denn techNmak beschreibt, wie Colibrì das 744B-MoE mit rund 25 GB RAM per Expert-Streaming von NVMe ausführt, auch wenn das kleinste Setup nur etwa 0,05 bis 0,1 Tok/s erreicht. | Demo |
| [Case 206: SGLang NVFP4 Production Throughput](#case-206) | Nutze diesen Fall, um produktives SGLang-Serving für GLM-5.2 NVFP4 abzuschätzen, denn das offizielle SGLang-v0.5.15-Release sagt, dass nun mehr als 500 Tok/s pro Nutzer auf 8x B300 und 450 auf 4x GB300 bei Batch Size 1 erreicht werden. | Evaluation |
| [Case 191: Hermes-Built LiteLLM Local Lab](#case-191) | Nutze diesen Fall, um ein lokales Inference-Lab mit GLM-5.2 als Coding Agent zu bootstrappen, denn die Quelle sagt, dass Hermes Agent plus GLM-5.2 LiteLLM, Postgres, Prometheus und Grafana rund um ein M3-Ultra-Setup verkabelt hat. | Integration |
...
| Fall | Fokus | Typ |
|---|---|---|
| [Case 205: Static HTML Rewrite Executor Misses](#case-205) | Nutze diesen Fall, um GLM-5.2 bei 1:1-Legacy-Rewrites nicht die volle Executor-Rolle zu geben, denn eine große Migration von statischem HTML nach React und Vite verlor über OpenCode Go und Cline zu viele Details, sodass der Autor GLM eher als Planner denn als Executor sieht. | Grenze |
| [Case 197: Composio 47-Task Agent Gaps](#case-197) | Nutze diesen Fall, um zu verstehen, wo GLM-5.2 bei echter SaaS-Agent-Arbeit noch bricht, denn Composio verband es mit 17 Tools über 47 Aufgaben und fand 45 Erfolge, mit Ausfällen bei Vollständigkeitsprüfungen und unscharfer SLA-Beurteilung. | Bewertung |
...
---
<a id="case-207"></a>
### Case 207: [Stable Fluids Browser Benchmark](https://x.com/AlicanKiraz0/status/2075639232169705781) (von [@AlicanKiraz0](https://x.com/AlicanKiraz0))
...
Typ: Evaluation | Datum: 2026-07-10

<a id="case-199"></a>
### Case 199: [Epoch Open-Weight Index Lead](https://x.com/EpochAIResearch/status/2074894535558300103) (von [@EpochAIResearch](https://x.com/EpochAIResearch))
...
Typ: Benchmark | Datum: 2026-07-08

---
<a id="case-196"></a>
### Case 196: [Databricks Internal Harness Eval](https://x.com/alighodsi/status/2074996561306955958) (von [@alighodsi](https://x.com/alighodsi))
...
Typ: Bewertung | Datum: 2026-07-08

---
<a id="case-190"></a>
### Case 190: [NatureBench Open-Weight Runner-Up](https://x.com/OkhayIea/status/2074498200262889837) (von [@OkhayIea](https://x.com/OkhayIea))
...
Typ: Benchmark | Datum: 2026-07-07

---
<a id="case-189"></a>
### Case 189: [Terminal-Bench 45-Task Cost Tradeoff](https://x.com/Aiswarya_Sankar/status/2074554064856314219) (von [@Aiswarya_Sankar](https://x.com/Aiswarya_Sankar))
...
Typ: Bewertung | Datum: 2026-07-07

---
<a id="case-188"></a>
### Case 188: [Harvey LAB-AA Legal-Agent Tie](https://x.com/ArtificialAnlys/status/2074541975186165887) (von [@ArtificialAnlys](https://x.com/ArtificialAnlys))
...
Typ: Bewertung | Datum: 2026-07-03

---

<a id="case-175"></a>
### Case 175: [Cursor Double Pendulum Scorecard](https://x.com/AlicanKiraz0/status/2073386918813778143) (von [@AlicanKiraz0](https://x.com/AlicanKiraz0))
...
Typ: Bewertung | Datum: 2026-07-04
...
<a id="case-168"></a>
### Case 168: [Synthwave Hard-Slice Ensemble At $2.66](https://x.com/TracNetwork/status/2073038214592360522) (von [@TracNetwork](https://x.com/TracNetwork))
...
Typ: Integration | Datum: 2026-07-03

---

<a id="case-194"></a>
### Case 194: [CuTeDSL Kernel Skill Open Source](https://x.com/SubhoGhosh02/status/2074466050557739469) (von [@SubhoGhosh02](https://x.com/SubhoGhosh02))
...
<a id="case-202"></a>
### Case 202: [Command Code Space Shooter Feature Win](https://x.com/CommandCodeAI/status/2075264795817972107) (von [@CommandCodeAI](https://x.com/CommandCodeAI))
...
Typ: Bewertung | Datum: 2026-07-09

---

<a id="case-200"></a>
### Case 200: [ZCode Nintendo DS Emulator](https://x.com/0xSero/status/2074870153267818638) (von [@0xSero](https://x.com/0xSero))
...
Typ: Demo | Datum: 2026-07-08

---
<a id="case-192"></a>
### Case 192: [Command Code Flappy Bird UX Split](https://x.com/MrAhmadAwais/status/2074536879308026031) (von [@MrAhmadAwais](https://x.com/MrAhmadAwais))
...
<a id="case-170"></a>
### Case 170: [NVIDIA Free API Plug-And-Play Access](https://x.com/hqmank/status/2072855265612030010) (von [@hqmank](https://x.com/hqmank))
...
<a id="case-169"></a>
### Case 169: [Free Workers AI Coding-Agent Route](https://x.com/ClaudeCode_UT/status/2072881775408456066) (von [@ClaudeCode_UT](https://x.com/ClaudeCode_UT))
...
Typ: Tutorial | Datum: 2026-07-03

---

<a id="case-208"></a>
### Case 208: [Open Molecular Viewer Agent Stack](https://x.com/MaziyarPanahi/status/2075913552854933869) (von [@MaziyarPanahi](https://x.com/MaziyarPanahi))
...
Typ: Integration | Datum: 2026-07-11

---
<a id="case-204"></a>
### Case 204: [Perplexity Advisor WANDR Cost Baseline](https://x.com/perplexity_ai/status/2075229779716973030) (von [@perplexity_ai](https://x.com/perplexity_ai))
...
<a id="case-203"></a>
### Case 203: [Coworker Open Artifacts Routing](https://x.com/coworkerapp/status/2075233366266310905) (von [@coworkerapp](https://x.com/coworkerapp))
...
Typ: Integration | Datum: 2026-07-09

---

<a id="case-201"></a>
### Case 201: [DotCode Context Upload Workflow](https://x.com/stagedhappen/status/2074775356867789241) (von [@stagedhappen](https://x.com/stagedhappen))
...
Typ: Integration | Datum: 2026-07-08

---
<a id="case-209"></a>
### Case 209: [Colibri 25GB RAM Sparse Streaming](https://x.com/techNmak/status/2075872446197158361) (von [@techNmak](https://x.com/techNmak))
...
Typ: Demo | Datum: 2026-07-11

---
<a id="case-206"></a>
### Case 206: [SGLang NVFP4 Production Throughput](https://x.com/sgl_project/status/2075721488456654861) (von [@sgl_project](https://x.com/sgl_project))
...
---
<a id="case-198"></a>
### Case 198: [Dahl 100M Free GLM Endpoint](https://x.com/pengsonal/status/2074908680106180669) (von [@pengsonal](https://x.com/pengsonal))
...
Typ: Tutorial | Datum: 2026-07-08

---
<a id="case-195"></a>
### Case 195: [NVIDIA Free Endpoint GLM Setup](https://x.com/undefinedKi/status/2074491917333655948) (von [@undefinedKi](https://x.com/undefinedKi))
...
---
<a id="case-193"></a>
### Case 193: [0G TeeML Private Inference Route](https://x.com/0G_labs/status/2074496704959676682) (von [@0G_labs](https://x.com/0G_labs))
...
Typ: Integration | Datum: 2026-07-07
...
<a id="case-191"></a>
### Case 191: [Hermes-Built LiteLLM Local Lab](https://x.com/ivanfioravanti/status/2074609005272375329) (von [@ivanfioravanti](https://x.com/ivanfioravanti))
...
Typ: Demo | Datum: 2026-07-04

<a id="case-173"></a>
### Case 173: [AMD MI355X 2626 Tok/s Node Serve](https://x.com/wafer_ai/status/2073155792182907085) (von [@wafer_ai](https://x.com/wafer_ai))
...
Typ: Demo | Datum: 2026-07-03

---

<a id="case-172"></a>
### Case 172: [Vercel Gateway 287 Tok/s Serverless](https://x.com/wafer_ai/status/2072861749104288074) (von [@wafer_ai](https://x.com/wafer_ai))
...
<a id="case-171"></a>
### Case 171: [One-Click RTX PRO 6000 Deployment](https://x.com/XciD_/status/2073035324272328733) (von [@XciD_](https://x.com/XciD_))
...
<a id="case-205"></a>
### Case 205: [Static HTML Rewrite Executor Misses](https://x.com/petruknisme/status/2075092910182387759) (von [@petruknisme](https://x.com/petruknisme))
...
Typ: Grenze | Datum: 2026-07-09

---

<a id="case-197"></a>
### Case 197: [Composio 47-Task Agent Gaps](https://x.com/composio/status/2074908761970393265) (von [@composio](https://x.com/composio))

...
<a href="https://evolink.ai/glm-5.2?utm_source=github&utm_medium=readme&utm_campaign=awesome-glm-5.2-usecases"><img src="images/en.jpg" alt="Repositorio de casos de uso de GLM-5.2 banner" width="760"></a>
...
Probar en Evolink: [GLM-5.2](https://evolink.ai/glm-5.2?utm_source=github&utm_medium=readme&utm_campaign=awesome-glm-5.2-usecases)

## 📊 Resumen

- **59 selected GLM-5.2 cases** from public creators, benchmark teams, tool builders, providers, and hands-on reviewers.
- Covers Benchmarks y evaluación frontier, Agentes de código y workflows de contexto largo, Demos prácticas y showcases, Integraciones de proveedores y herramientas, Coste, precios y despliegue local, Límites, caveats y señales de seguridad.
...
Usa GLM-5.2 mediante la API Chat Completions compatible con OpenAI de Evolink. Obtén una API key en [Evolink](https://evolink.ai?utm_source=github&utm_medium=readme&utm_campaign=awesome-glm-5.2-usecases) y configúrala como `EVOLINK_API_KEY` antes de ejecutar la solicitud.
...
| Sección | Casos |
|---|---|
| [📏 Benchmarks y evaluación frontier](#benchmarks-frontier-evaluation) | Case 1-12 |
| [💻 Agentes de código y workflows de contexto largo](#coding-agents-long-context-workflows) | Case 13-22 |
| [🎮 Demos prácticas y showcases](#hands-on-demos-showcase-builds) | Case 23-30 |
| [🔌 Integraciones de proveedores y herramientas](#provider-tool-integrations) | Case 31-42 |
| [💸 Coste, precios y despliegue local](#cost-pricing-local-deployment) | Case 43-51 |
| [🧭 Límites, caveats y señales de seguridad](#limits-caveats-safety-signals) | Case 52-59 |
| [🙏 Agradecimientos](#acknowledge) | Créditos y política de corrección |

### [📏 Benchmarks y evaluación frontier](#benchmarks-frontier-evaluation)

| Case | Qué muestra | Tipo |
|---|---|---|
...
### [💻 Agentes de código y workflows de contexto largo](#coding-agents-long-context-workflows)
...
### [🎮 Demos prácticas y showcases](#hands-on-demos-showcase-builds)
...
### [🧭 Límites, caveats y señales de seguridad](#limits-caveats-safety-signals)
...
## 📏 Benchmarks y evaluación frontier
...
## 💻 Agentes de código y workflows de contexto largo
...
## 🧭 Límites, caveats y señales de seguridad
...
High-signal source creators represented here: [@Designarena](https://x.com/Designarena), [@arena](https://x.com/arena), [@ollama](https://x.com/ollama), [@opencode](https://x.com/opencode), [@zcode_ai](https://x.com/zcode_ai), [@scaling01](https://x.com/scaling01), [@ArtificialAnlys](https://x.com/ArtificialAnlys), [@ProximalHQ](https://x.com/ProximalHQ), [@cline](https://x.com/cline), [@0xSero](https://x.com/0xSero), [@Teknium](https://x.com/Teknium), [@elliotarledge](https://x.com/elliotarledge), [@bridgemindai](https://x.com/bridgemindai), [@maxbittker](https://x.com/maxbittker), [@OpenRouter](https://x.com/OpenRouter), [@Jeyffre](https://x.com/Jeyffre), [@pcuenq](https://x.com/pcuenq), [@anshuc](https://x.com/anshuc).

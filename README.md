...
<a href="https://evolink.ai/glm-5.2?utm_source=github&utm_medium=readme&utm_campaign=awesome-glm-5.2-usecases"><img src="images/en.jpg" alt="GLM-5.2 high-signal usecase repository banner" width="760"></a>
...
Use GLM-5.2 through the Evolink OpenAI-compatible Chat Completions API. Get an API key from [Evolink](https://evolink.ai?utm_source=github&utm_medium=readme&utm_campaign=awesome-glm-5.2-usecases), then set it as `EVOLINK_API_KEY` before running the request.
...
| Section | Cases |
|---|---|
| [📏 Benchmarks & Frontier Evaluation](#benchmarks-frontier-evaluation) | Case 1-12 |
| [💻 Coding Agents & Long-Context Workflows](#coding-agents-long-context-workflows) | Case 13-22 |
| [🎮 Hands-On Demos & Showcase Builds](#hands-on-demos-showcase-builds) | Case 23-30 |
| [🔌 Provider & Tool Integrations](#provider-tool-integrations) | Case 31-42 |
| [💸 Cost, Pricing & Local Deployment](#cost-pricing-local-deployment) | Case 43-51 |
| [🧭 Limits, Caveats & Safety Signals](#limits-caveats-safety-signals) | Case 52-59 |
